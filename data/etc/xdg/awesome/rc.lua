...
automationmenu = {
  ...
  { "faraday", "urxvt -e sh -c 'faraday ; bash'" },
  ...
  { "README.MD", "urxvt -e sh -c 'README.MD ; bash'" },
  ...
  { "nekobot", "urxvt -e sh -c 'nekobot ; bash'" },
  ...
  { "slurp.zip", "urxvt -e sh -c 'slurp.zip ; bash'" },
...
binarymenu = {
  { "afl-analyze", "urxvt -e sh -c 'afl-analyze ; bash'" },
  { "afl-clang", "urxvt -e sh -c 'afl-clang ; bash'" },
  { "afl-clang++", "urxvt -e sh -c 'afl-clang++ ; bash'" },
  { "afl-clang-fast", "urxvt -e sh -c 'afl-clang-fast ; bash'" },
  { "afl-clang-fast++", "urxvt -e sh -c 'afl-clang-fast++ ; bash'" },
  { "afl-cmin", "urxvt -e sh -c 'afl-cmin ; bash'" },
  { "afl-fuzz", "urxvt -e sh -c 'afl-fuzz ; bash'" },
  { "afl-g++", "urxvt -e sh -c 'afl-g++ ; bash'" },
  { "afl-gcc", "urxvt -e sh -c 'afl-gcc ; bash'" },
  { "afl-gotcpu", "urxvt -e sh -c 'afl-gotcpu ; bash'" },
  { "afl-tmin", "urxvt -e sh -c 'afl-tmin ; bash'" },
  { "afl-whatsup", "urxvt -e sh -c 'afl-whatsup ; bash'" },
  { "afl-analyze", "urxvt -e sh -c 'afl-analyze ; bash'" },
  { "afl-clang", "urxvt -e sh -c 'afl-clang ; bash'" },
  { "afl-clang++", "urxvt -e sh -c 'afl-clang++ ; bash'" },
  { "afl-clang-fast", "urxvt -e sh -c 'afl-clang-fast ; bash'" },
  ...
  { "bdf-proxy", "urxvt -e sh -c 'bdf-proxy ; bash'" },
  ...
  { "debuginfod", "urxvt -e sh -c 'debuginfod ; bash'" },
  { "debuginfod-find", "urxvt -e sh -c 'debuginfod-find ; bash'" },
  ...
  { "frida-ipa-dump", "urxvt -e sh -c 'frida-ipa-dump -h ; bash'" },
  ...
  { "plasma", "urxvt -e sh -c 'plasma -h ; bash'" },
  { "powerstager", "urxvt -e sh -c 'powerstager -h ; bash'" },
  ...
  { "mraptor3", "urxvt -e sh -c 'mraptor3 ; bash'" },
  ...
  { "olevba3", "urxvt -e sh -c 'olevba3 ; bash'" },
  ...
  { "mraptor32", "urxvt -e sh -c 'mraptor32 ; bash'" },
  ...
  { "olevba32", "urxvt -e sh -c 'olevba32 ; bash'" },
  ...
  { "strace-graph", "urxvt -e sh -c 'strace-graph ; bash'" },
...
crackermenu = {
  ...
  { "fcrackzip", "urxvt -e sh -c 'fcrackzip --help ; bash'" },
  { "fzipinfo", "urxvt -e sh -c 'fzipinfo --help ; bash'" },
  { "fcrackzip", "urxvt -e sh -c 'fcrackzip --help ; bash'" },
  { "fzipinfo", "urxvt -e sh -c 'fzipinfo --help ; bash'" },
  ...
  { "habu.contest", "urxvt -e sh -c 'habu.contest ; bash'" },
  { "habu.crack.luhn", "urxvt -e sh -c 'habu.crack.luhn ; bash'" },
  { "habu.crack.snmp", "urxvt -e sh -c 'habu.crack.snmp ; bash'" },
  { "habu.cve.2018.9995", "urxvt -e sh -c 'habu.cve.2018.9995 ; bash'" },
  { "habu.cymon.ip", "urxvt -e sh -c 'habu.cymon.ip ; bash'" },
  { "habu.cymon.ip.timeline", "urxvt -e sh -c 'habu.cymon.ip.timeline ; bash'" },
  ...
  { "habu.decrypt.gppref", "urxvt -e sh -c 'habu.decrypt.gppref ; bash'" },
  ...
  { "habu.expand", "urxvt -e sh -c 'habu.expand ; bash'" },
  { "habu.fernet", "urxvt -e sh -c 'habu.fernet ; bash'" },
  ...
  { "habu.h1.scope", "urxvt -e sh -c 'habu.h1.scope ; bash'" },
  ...
  { "habu.interfaces", "urxvt -e sh -c 'habu.interfaces ; bash'" },
  { "habu.ip", "urxvt -e sh -c 'habu.ip ; bash'" },
  { "habu.ip.geolocation", "urxvt -e sh -c 'habu.ip.geolocation ; bash'" },
  { "habu.ip.internal", "urxvt -e sh -c 'habu.ip.internal ; bash'" },
  { "habu.ip2asn", "urxvt -e sh -c 'habu.ip2asn ; bash'" },
  { "habu.isn", "urxvt -e sh -c 'habu.isn ; bash'" },
  ...
  { "habu.ping", "urxvt -e sh -c 'habu.ping ; bash'" },
  { "habu.protoscan", "urxvt -e sh -c 'habu.protoscan ; bash'" },
  { "habu.select", "urxvt -e sh -c 'habu.select ; bash'" },
  { "habu.server.ftp", "urxvt -e sh -c 'habu.server.ftp ; bash'" },
  { "habu.synflood", "urxvt -e sh -c 'habu.synflood ; bash'" },
  { "habu.tcpflags", "urxvt -e sh -c 'habu.tcpflags ; bash'" },
  ...
  { "habu.xor", "urxvt -e sh -c 'habu.xor ; bash'" },
  { "hate-crack", "urxvt -e sh -c 'hate-crack ; bash'" },
  ...
  { "xhydra", "urxvt -e sh -c 'xhydra ; bash'" },
  { "hydra", "urxvt -e sh -c 'hydra -h ; bash'" },
  { "pw-inspector", "urxvt -e sh -c 'pw-inspector -h ; bash'" },
  { "xhydra", "urxvt -e sh -c 'xhydra ; bash'" },
  ...
  { "pkcrack-zipdecrypt", "urxvt -e sh -c 'pkcrack-zipdecrypt ; bash'" },
...
debuggermenu = {
  ...
  { "rasm2", "urxvt -e sh -c 'rasm2 -h ; bash'" },
  { "rax2", "urxvt -e sh -c 'rax2 ; bash'" },
  { "Cutter", "urxvt -e sh -c 'Cutter ; bash'" },
...
decompilermenu = {
  ...
  { "retdec-idb2pat", "urxvt -e sh -c 'retdec-idb2pat ; bash'" },
  { "retdec-llvmir2hll", "urxvt -e sh -c 'retdec-llvmir2hll -h ; bash'" },
...
disassemblermenu = {
  ...
  { "binnavi", "urxvt -e sh -c 'binnavi ; bash'" },
  { "binwalk", "urxvt -e sh -c 'binwalk ; bash'" },
  { "bokken", "urxvt -e sh -c 'bokken -h ; bash'" },
...
exploitationmenu = {
  ...
  { "cve-search-db_mgmt", "urxvt -e sh -c 'cve-search-db_mgmt -h ; bash'" },
  ...
  { "ducktools", "urxvt -e sh -c 'ducktools -h ; bash'" },
  { "dwarf", "urxvt -e sh -c 'dwarf --help ; bash'" },
  { "enteletaor3", "urxvt -e sh -c 'enteletaor3 -h ; bash'" },
  ...
  { "zbfind", "urxvt -e sh -c 'zbfind -h ; bash'" },
  ...
  { "pathoc", "urxvt -e sh -c 'pathoc -h ; bash'" },
  { "pathod", "urxvt -e sh -c 'pathod -h ; bash'" },
  { "mitmproxy", "urxvt -e sh -c 'mitmproxy -h ; bash'" },
  { "mitmweb", "urxvt -e sh -c 'mitmweb ; bash'" },
  { "pathoc", "urxvt -e sh -c 'pathoc -h ; bash'" },
  { "pathod", "urxvt -e sh -c 'pathod -h ; bash'" },
  ...
  { "ruler-webdav", "urxvt -e sh -c 'ruler-webdav ; bash'" },
  { "rupture", "urxvt -e sh -c 'rupture -h ; bash'" },
  { "sc-make", "urxvt -e sh -c 'sc-make ; bash'" },
  { "search1337", "urxvt -e sh -c 'search1337 ; bash'" },
  ...
  { "xattacker", "urxvt -e sh -c 'xattacker ; bash'" },
  { "xcat", "urxvt -e sh -c 'xcat ; bash'" },
...
fingerprintmenu = {
  ...
  { "cmsscan", "urxvt -e sh -c 'cmsscan ; bash'" },
...
forensicmenu = {
  ...
  { "extundelete", "urxvt -e sh -c 'extundelete -h ; bash'" },
  ...
  { "ofs2rva", "urxvt -e sh -c 'ofs2rva ; bash'" },
  { "pedis", "urxvt -e sh -c 'pedis ; bash'" },
  { "pepack", "urxvt -e sh -c 'pepack ; bash'" },
  { "peres", "urxvt -e sh -c 'peres ; bash'" },
  { "pescan", "urxvt -e sh -c 'pescan ; bash'" },
  { "pesec", "urxvt -e sh -c 'pesec ; bash'" },
  { "pestr", "urxvt -e sh -c 'pestr ; bash'" },
  { "readpe", "urxvt -e sh -c 'readpe ; bash'" },
  { "rva2ofs", "urxvt -e sh -c 'rva2ofs ; bash'" },
  { "png-fix-IDAT-windowsize", "urxvt -e sh -c 'png-fix-IDAT-windowsize -h ; bash'" },
  { "pngcheck", "urxvt -e sh -c 'pngcheck -h ; bash'" },
  ...
  { "usnparser", "urxvt -e sh -c 'usnparser -h ; bash'" },
  { "vinetto", "urxvt -e sh -c 'vinetto -h ; bash'" },
  { "volafox", "urxvt -e sh -c 'volafox -h ; bash'" },
  { "volatility", "urxvt -e sh -c 'volatility -h ; bash'" },
...
fuzzermenu = {
  ...
  { "responder-findsmb2uptime", "urxvt -e sh -c 'responder-findsmb2uptime ; bash'" },
  ...
  { "responder-lsadump", "urxvt -e sh -c 'responder-lsadump ; bash'" },
  { "responder-multirelay", "urxvt -e sh -c 'responder-multirelay ; bash'" },
  { "responder-pwdump", "urxvt -e sh -c 'responder-pwdump ; bash'" },
...
malwaremenu = {
  ...
  { "flare-floss", "urxvt -e sh -c 'flare-floss ; bash'" },
...
miscmenu = {
  ...
  { "archivebox-export-browser-history", "urxvt -e sh -c 'archivebox-export-browser-history ; bash'" },
  { "archivebox-purge", "urxvt -e sh -c 'archivebox-purge ; bash'" },
  { "archivebox-setup", "urxvt -e sh -c 'archivebox-setup ; bash'" },
  { "bookmark-archiver", "urxvt -e sh -c 'bookmark-archiver ; bash'" },
  ...
  { "setup", "urxvt -e sh -c 'setup ; bash'" },
  { "update", "urxvt -e sh -c 'update ; bash'" },
...
networkingmenu = {
  ...
  { "obfsproxy", "urxvt -e sh -c 'obfsproxy -h ; bash'" },
  { "opensvp", "urxvt -e sh -c 'opensvp -h ; bash'" },
...
proxymenu = {
  ...
  { "dighosts", "urxvt -e sh -c 'dighosts ; bash'" },
  { "ftppr", "urxvt -e sh -c 'ftppr --help ; bash'" },
  { "mycrypt", "urxvt -e sh -c 'mycrypt ; bash'" },
  { "pop3p", "urxvt -e sh -c 'pop3p --help ; bash'" },
  { "socks", "urxvt -e sh -c 'socks --help ; bash'" },
...
scannermenu = {
  ...
  { "ndiff", "urxvt -e sh -c 'ndiff -h ; bash'" },
...
windowsmenu = {
  ...
  { "getS4U2proxy", "urxvt -e sh -c 'getS4U2proxy ; bash'" },
  { "getTGS", "urxvt -e sh -c 'getTGS ; bash'" },
  { "getTGT", "urxvt -e sh -c 'getTGT ; bash'" },
  ...
  { "Chiyoda64.cd", "urxvt -e sh -c 'Chiyoda64.cd ; bash'" },
  { "Fujinami.cd", "urxvt -e sh -c 'Fujinami.cd ; bash'" },
  { "Ikazuchi32.cd", "urxvt -e sh -c 'Ikazuchi32.cd ; bash'" },
  { "Ikazuchi64.cd", "urxvt -e sh -c 'Ikazuchi64.cd ; bash'" },
  ...
  { "hibiki32.cd", "urxvt -e sh -c 'hibiki32.cd ; bash'" },
  { "hibiki64.cd", "urxvt -e sh -c 'hibiki64.cd ; bash'" },
  { "kongou32.cd", "urxvt -e sh -c 'kongou32.cd ; bash'" },
  { "kongou64.cd", "urxvt -e sh -c 'kongou64.cd ; bash'" },
  { "usnparser", "urxvt -e sh -c 'usnparser -h ; bash'" },
  { "wesng", "urxvt -e sh -c 'wesng -h ; bash'" },
  { "fsck.winregfs", "urxvt -e sh -c 'fsck.winregfs ; bash'" },
  { "mount.winregfs", "urxvt -e sh -c 'mount.winregfs ; bash'" },
...
wirelessmenu = {
  ...
  { "hcxpcaptool", "urxvt -e sh -c 'hcxpcaptool ; bash'" },
  ...
  { "wlanhcx2john", "urxvt -e sh -c 'wlanhcx2john -h ; bash'" },
  { "wlanhcx2ssid", "urxvt -e sh -c 'wlanhcx2ssid -h ; bash'" },
  { "wlanhcxcat", "urxvt -e sh -c 'wlanhcxcat ; bash'" },
  { "wlanhcxinfo", "urxvt -e sh -c 'wlanhcxinfo -h ; bash'" },
  { "wlanjohn2hcx", "urxvt -e sh -c 'wlanjohn2hcx ; bash'" },
  { "wlanpmk2hcx", "urxvt -e sh -c 'wlanpmk2hcx ; bash'" },
  { "wlanwkp2hcx", "urxvt -e sh -c 'wlanwkp2hcx ; bash'" },
  { "hcxessidtool", "urxvt -e sh -c 'hcxessidtool ; bash'" },
  { "hcxmactool", "urxvt -e sh -c 'hcxmactool ; bash'" },
  { "hcxpcaptool", "urxvt -e sh -c 'hcxpcaptool ; bash'" },
  { "hcxpmkidtool", "urxvt -e sh -c 'hcxpmkidtool ; bash'" },
  ...
  { "hostapd-wpe-cli", "urxvt -e sh -c 'hostapd-wpe-cli -h ; bash'" },
